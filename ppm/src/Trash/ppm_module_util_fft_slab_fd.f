      !-------------------------------------------------------------------------
      !  Module       :           ppm_module_util_fft_slab_fd
      !-------------------------------------------------------------------------
      !
      !  Purpose      : This module includes the source code for the fft 
      !                  routines that do two directions (slab), but
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_module_util_fft_slab_fd.f,v $
...
#define __SLAB                      10
      ...
      MODULE ppm_module_util_fft_slab_fd
         ...
         INTERFACE ppm_util_fft_fd_full
            ...
            MODULE PROCEDURE ppm_util_fft_slab_fd_3dc
            MODULE PROCEDURE ppm_util_fft_slab_fd_3dcc
         END INTERFACE
...
#include "ppm_util_fft_slab_fd_3d.f"
#undef __KIND
...
#undef __KIND
      ...
      END MODULE ppm_module_util_fft_slab_fd
