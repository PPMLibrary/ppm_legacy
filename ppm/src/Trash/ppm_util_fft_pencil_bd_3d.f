      !-------------------------------------------------------------------------
      !  Subroutine   :               ppm_util_fft_pencil_bd_3d
      !-------------------------------------------------------------------------
      !
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_util_fft_pencil_bd_3d.f,v $
      ...
      SUBROUTINE ppm_util_fft_pencil_bd_3ds(data_in,lda,data_out,info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_util_fft_pencil_bd_3dd(data_in,lda,data_out,info)
#elif __KIND == __SINGLE_PRECISION_COMPLEX
      SUBROUTINE ppm_util_fft_pencil_bd_3dc(data_in,lda,data_out,info)
#elif __KIND == __DOUBLE_PRECISION_COMPLEX
      SUBROUTINE ppm_util_fft_pencil_bd_3dcc(data_in,lda,data_out,info)
#endif
...
#include "ppm_define.h"
      ...
      !  Initialise
      !-------------------------------------------------------------------------
      CALL substart('ppm_util_fft_pencil_bd_3d',t0,info)
...
#ifndef __FFTW
      CALL ppm_error(ppm_err_nofftw,'ppm_util_fft_pencil_bd_3d',  &
     &    'PPM was compiled without fftw support',__LINE__,info)
#endif

#ifndef __MATHKEISAN
      CALL ppm_error(ppm_err_noMathKeisan,'ppm_util_fft_pencil_bd_3d',  &
     &    'PPM was compiled without MATHKEISAN support',__LINE__,info)
      ...
      IF (ppm_debug .GT. 0) THEN
          IF (SIZE(lda,1) .LT. 3) THEN
              info = ppm_error_error
              CALL ppm_error(ppm_err_argument,'ppm_util_fft_pencil_bd_3d',  &
...
!      lda(1)=Nx_out 
      ...
      IF (info .NE. 0) THEN
          ...
          CALL ppm_error(ppm_err_alloc,'ppm_util_fft_pencil_bd_3d',     &
     ...
     &  FFTW_BACKWARD, FFTW_ESTIMATE)
      ...
      !-------------------------------------------------------------------------
 9999 CONTINUE
      CALL substop('ppm_util_fft_pencil_bd_3d',t0,info)
      RETURN
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_pencil_bd_3ds
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_pencil_bd_3dd
#elif __KIND == __SINGLE_PRECISION_COMPLEX
      END SUBROUTINE ppm_util_fft_pencil_bd_3dc
#elif __KIND == __DOUBLE_PRECISION_COMPLEX
      END SUBROUTINE ppm_util_fft_pencil_bd_3dcc
#endif
