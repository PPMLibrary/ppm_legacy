      !-------------------------------------------------------------------------
      !  Module       :          ppm_module_util_fft_slab_bd
      !-------------------------------------------------------------------------
      !
      !  Purpose      : This module includes the source code for the fft 
      !                  routines that do two space directions (slab),
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_module_util_fft_slab_bd.f,v $
...
#define __SLAB                      10
      ...
      MODULE ppm_module_util_fft_slab_bd
         ...
         INTERFACE ppm_util_fft_bd_full
            ...
            MODULE PROCEDURE ppm_util_fft_slab_bd_3dc
            MODULE PROCEDURE ppm_util_fft_slab_bd_3dcc
         END INTERFACE
...
#include "ppm_util_fft_slab_bd_3d.f"
#undef __KIND
...
#undef __KIND
      ...
      END MODULE ppm_module_util_fft_slab_bd
