      !-------------------------------------------------------------------------
      !  Subroutine   :               ppm_util_fft_slab_fft_fd_3d
      !-------------------------------------------------------------------------
      !
      !  Purpose      : This routine performs Fast Fourier Transform in 2d
      !                 using a slab topology.
      !
      ...
      !  Revisions    :
      !-------------------------------------------------------------------------
      !  $Log: ppm_util_fft_slab_fd_3d.f,v $
      ...
      SUBROUTINE ppm_util_fft_slab_fft_fd_3ds(data_in,lda,data_out,info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_util_fft_slab_fft_fd_3dd(data_in,lda,data_out,info)
#endif
      !-------------------------------------------------------------------------
      !  Includes
      !-------------------------------------------------------------------------
#include "ppm_define.h"
      ...
      !  Initialise
      !-------------------------------------------------------------------------
      CALL substart('ppm_util_fft_slab_fft_fd_3d',t0,info)
...
#ifndef __FFTW
      CALL ppm_error(ppm_err_nofftw,'ppm_util_fft_slab_fft_fd_3d',  &
     &    'PPM was compiled without fftw support',__LINE__,info)
#endif

#ifndef __MATHKEISAN
      CALL ppm_error(ppm_err_noMathKeisan,'ppm_util_fft_slab_fft_fd_3d',  &
     &    'PPM was compiled without MATHKEISAN support',__LINE__,info)
      ...
      IF (ppm_debug .GT. 0) THEN
          IF (SIZE(lda,1) .LT. 3) THEN
              info = ppm_error_error
              CALL ppm_error(ppm_err_argument,'ppm_util_fft_slab_fft_fd_3d',  &
     ...
     &            'mesh size: lda(3) must be >0' ,__LINE__,info)
      ...
      IF (info .NE. 0) THEN
          ...
          CALL ppm_error(ppm_err_alloc,'ppm_util_fft_slab_fft_fd_3d',     &
     &        'fft result DATA_OUT',__LINE__,info)
      ...
      !-------------------------------------------------------------------------
          ...
          info = ppm_error_fatal
          CALL ppm_error(ppm_err_alloc,'ppm_util_fft_slab_fft_fd_2d',     &
     ...
     IF (info .NE. 0) THEN
          ...
          info = ppm_error_error
          CALL ppm_error(ppm_err_dealloc,'ppm_util_fft_slab_fft_fd_3d',mesg,__LINE__,&
     &                                                                 info)
          GOTO 9999
      ENDIF
#endif
      ...
      !-------------------------------------------------------------------------
 9999 CONTINUE
      CALL substop('ppm_util_fft_slab_fft_fd_3d',t0,info)
      RETURN
...
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_slab_fft_fd_slab_3ds
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_slab_fft_fd_slab_3dd
#endif
...
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_slab_fft_fd_3ds
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_slab_fft_fd_3dd
#elif __KIND == __SINGLE_PRECISION_COMPLEX
      END SUBROUTINE ppm_util_fft_slab_fft_fd_3dc
#elif __KIND == __DOUBLE_PRECISION_COMPLEX
      END SUBROUTINE ppm_util_fft_slab_fft_fd_3dcc
#elif __KIND == __SINGLE_PRECISION_COMPLEX_Z
      END SUBROUTINE ppm_util_fft_slab_fft_fd_z_3dc
#elif __KIND == __DOUBLE_PRECISION_COMPLEX_Z
      END SUBROUTINE ppm_util_fft_slab_fft_fd_z_3dcc
#endif
