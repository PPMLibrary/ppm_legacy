      ...
      !-------------------------------------------------------------------------
      !
      !  Purpose      : Parallel forward FFT for 2D arrays. This does the
...
=======
      ...
      SUBROUTINE ppm_util_fft_forward_2d_ss(DATA_fv, mesh_id_user,&
         topo_ids, mesh_ids, ghostsize,  info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_util_fft_forward_2d_sd(DATA_fv, mesh_id_user,&
         topo_ids, mesh_ids,  ghostsize,info)
#endif
#endif
...
#if   __DIM == __VFIELD
#if   __KIND == __SINGLE_PRECISION
      SUBROUTINE ppm_util_fft_forward_2d_vs(DATA_fv, lda_fv, mesh_id_user, &
     &  topo_ids, mesh_ids, ghostsize, info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_util_fft_forward_2d_vd(DATA_fv, lda_fv, mesh_id_user, &
     &  topo_ids, mesh_ids, ghostsize, info)
#endif
#endif
...
#include "ppm_define.h"
      ...
      IF (ppm_debug .GT. 0) THEN
          IF (.NOT. ppm_initialized) THEN
              ...
              CALL ppm_error(ppm_err_ppm_noinit,'ppm_util_fft_forward_2d',  &
     ...
     &            'No field topology has been defined so far',__LINE__,info)
      ...
      NULLIFY(ndata,ndata_trans,ndata_ypen,ndata_xpen_complex)
      NULLIFY(sub2proc,isublist,data_out)
    ...
    &           .GT.yhmax) THEN
     ...
     &        'data_in array',__LINE__,info)
      ...
      !  FFT - Backward Transformation in y-direction
      !-------------------------------------------------------------------------
      CALL ppm_util_fft_step_bd(FFT_x,ndata_xpen_complex(:,idom),Result,info)
...
#if   __DIM == __SFIELD
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_forward_2d_ss
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_forward_2d_sd
#endif
#endif

#if   __DIM == __VFIELD
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_forward_2d_vs
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_forward_2d_vd
#endif
#endif
