      ...
      SUBROUTINE ppm_util_fft_map_2d_sca_s(data_fv,topo_ids,mesh_ids,info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_util_fft_map_2d_sca_d(data_fv,topo_ids,mesh_ids,info)
#elif __KIND == __COMPLEX
      SUBROUTINE ppm_util_fft_map_2d_sca_c(data_fv,topo_ids,mesh_ids,info)
#elif __KIND == __DOUBLE_COMPLEX
      SUBROUTINE ppm_util_fft_map_2d_sca_cc(data_fv,topo_ids,mesh_ids,info)
#endif
#endif

#if   __DIM == __VFIELD
#if   __KIND == __SINGLE_PRECISION
      SUBROUTINE ppm_util_fft_map_2d_vec_s(data_fv,lda,topo_ids,mesh_ids,info)
#elif __KIND == __DOUBLE_PRECISION
      SUBROUTINE ppm_util_fft_map_2d_vec_d(data_fv,lda,topo_ids,mesh_ids,info)
#elif __KIND == __COMPLEX
      SUBROUTINE ppm_util_fft_map_2d_vec_c(data_fv,lda,topo_ids,mesh_ids,info)
#elif __KIND == __DOUBLE_COMPLEX
      SUBROUTINE ppm_util_fft_map_2d_vec_cc(data_fv,lda,topo_ids,mesh_ids,info)
#endif
#endif
      ...
      !  Initialise
      !-------------------------------------------------------------------------
      CALL substart('ppm_util_fft_map_2d',t0,info)
      ...
      IF (ppm_debug .GT. 0) THEN
          IF (ppm_internal_topoid(topo_ids(1)) .NE. ppm_field_topoid) THEN
              ...
              CALL ppm_error(ppm_err_argument,'ppm_util_fft_map_2d',  &
     ...
     &     ghostsize,maptype,info)
      ...
      !-------------------------------------------------------------------------
 9999 CONTINUE
      CALL substop('ppm_util_fft_map_2d',t0,info)
      RETURN

#if   __DIM == __SFIELD
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_map_2d_sca_s
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_map_2d_sca_d
#elif __KIND == __COMPLEX
      END SUBROUTINE ppm_util_fft_map_2d_sca_c
#elif __KIND == __DOUBLE_COMPLEX
      END SUBROUTINE ppm_util_fft_map_2d_sca_cc
#endif
#endif

#if   __DIM == __VFIELD
#if   __KIND == __SINGLE_PRECISION
      END SUBROUTINE ppm_util_fft_map_2d_vec_s
#elif __KIND == __DOUBLE_PRECISION
      END SUBROUTINE ppm_util_fft_map_2d_vec_d
#elif __KIND == __COMPLEX
      END SUBROUTINE ppm_util_fft_map_2d_vec_c
#elif __KIND == __DOUBLE_COMPLEX
      END SUBROUTINE ppm_util_fft_map_2d_vec_cc
#endif
#endif
