...
#include "ppm_define.h"
          ...
          !---------------------------------------------------------------------
          REAL(ppm_kind_single), DIMENSION(:),POINTER :: table_fd_s,     &
     &                                                   table_bd_s
          REAL(ppm_kind_double), DIMENSION(:),POINTER :: table_fd_d,     &
     &                                                   table_bd_d
          REAL(ppm_kind_single), DIMENSION(:),POINTER :: table_fd_c_y,   &
     &                                                   table_bd_c_y
          REAL(ppm_kind_double), DIMENSION(:),POINTER :: table_fd_cc_y,  &
     &                                                   table_bd_cc_y
          REAL(ppm_kind_single), DIMENSION(:),POINTER :: table_fd_c_z,   &
     &                                                   table_bd_c_z
          REAL(ppm_kind_double), DIMENSION(:),POINTER :: table_fd_cc_z,  &
     &                                                   table_bd_cc_z
#endif
          !---------------------------------------------------------------------
          !  Table sizes
