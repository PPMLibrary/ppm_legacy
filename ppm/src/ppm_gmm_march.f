      ...
      !
      !                 S. Kim. An O(N) level set method for Eikonal equations.
      ...
      !
      !  Revision 1.11  2006/11/24 12:46:43  pchatela
      !  Bugfix: Added missing collective communication call for total size of Gamma
      !
      !  Revision 1.10  2006/07/03 12:57:36  ivos
